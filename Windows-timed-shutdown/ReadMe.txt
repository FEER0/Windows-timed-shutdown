========================================================================
    ANWENDUNG: Windows-timed-shutdown-Projektübersicht
========================================================================

Diese Windows-timed-shutdown-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Windows-timed-shutdown-Anwendung besteht.

Windows-timed-shutdown.vcxproj
...
Windows-timed-shutdown.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Windows-timed-shutdown.pch und eine 
